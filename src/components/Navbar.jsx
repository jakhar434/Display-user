          ...
          <div>
            <div className="dropDown">
              <div className="group">
                ...
                <select value={groups} onChange={(e) => handleGroups(e, true)} name="group" id="group">
              ...
              <div className="group">
                ...
                <select value={order} onChange={(e) => handleGroups(e, false)} name="order" id="order">
                  <option value="priority">Priority</option>
